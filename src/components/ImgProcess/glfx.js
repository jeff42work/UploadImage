...
var fx = (function () {
  ...
  function B(b, d) {
    ...
    this._.flippedShader =
      this._.flippedShader ||
      new h(null, "uniform sampler2D texture;varying vec2 texCoord;void main(){gl_FragColor=texture2D(texture,vec2(texCoord.x,1.0-texCoord.y));}");
  ...
  function z(a) {
    ...
    for (c = 1; c < d - 1; ++c) {
      ...
      this.y2[c] = (e - 1) / g;
      this.u[c] =
        ((6 * ((this.ya[c + 1] - this.ya[c]) / (this.xa[c + 1] - this.xa[c]) - (this.ya[c] - this.ya[c - 1]) / (this.xa[c] - this.xa[c - 1]))) / a -
          e * this.u[c - 1]) /
        g;
    }
    this.y2[d - 1] = 0;
  ...
  function Q(b, d, c) {
    ...
    a.lensBlur2 =
      a.lensBlur2 ||
      new h(null, e + "void main(){vec4 color=(sample(delta0)+2.0*texture2D(texture1,texCoord))/3.0;gl_FragColor=pow(color,vec4(power));}").textures({
        texture1: 1,
      });
    for (var e = [], g = 0; 3 > g; g++) {
    ...
    function c(a) {
      "OES_texture_float_linear" === a
        ? (void 0 === this.$OES_texture_float_linear$ &&
            Object.defineProperty(this, "$OES_texture_float_linear$", { enumerable: !1, configurable: !1, writable: !1, value: new d() }),
  ...
  var h = (function () {
    ...
    d.prototype.drawRect = function (b, c, e, d) {
      ...
      null == this.vertexAttribute &&
        ((this.vertexAttribute = a.getAttribLocation(this.program, "vertex")), a.enableVertexAttribArray(this.vertexAttribute));
      null == this.texCoordAttribute &&
        ((this.texCoordAttribute = a.getAttribLocation(this.program, "_texCoord")), a.enableVertexAttribArray(this.texCoordAttribute));
      a.useProgram(this.program);
      a.bindBuffer(a.ARRAY_BUFFER, a.vertexBuffer);
